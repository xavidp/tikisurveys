...
if (check.one.field) {
    ...
    # Test for the error in names issue "Tabaco -- 19", for instance
    #which(my.tfd$fieldId==19)
    # [1] 83
    #my.tfd[which(my.tfd$fieldId==19),"options"]
    # [1] "{\"options\":[\"0=No\",\"1=S\303\255\",\"99=ns/nc\"]}"
    #table(as.numeric(my.tfd$fieldId)==19)
    #class(my.tfd$fieldId)
    my.options <- unlist(fromJSON(as.character(my.tfd[which(as.numeric(my.tfd$fieldId)==19),"options"])))
    ...
    my.field.data2 <- set_labels(my.field.data, memisc::labels(my.field.labels))
    get_labels(my.field.data2, include.values = T,  include.non.labelled = TRUE)
    #view_df(data.frame(my.field.data2))
    #my.field.data3 <- set_labels(my.field.data, memisc::labels(my.field.labels), 
    #                             force.labels = TRUE, force.values = FALSE)
    #get_labels(my.field.data3, include.values = T,  include.non.labelled = TRUE)
    #view_df(data.frame(my.field.data3))
