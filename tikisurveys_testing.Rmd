...
# if it fails for some reason, like the package is just updated online but CRAN still points to the old package which is not available anymore, then you can install through github:
...
# Load the httr package which will allow you to authenticate from R to your Tiki instance
if (!require("httr")) {
  install.packages("httr")
}
require(httr)
...
my.c.encoding <- stringi::stri_enc_detect(content(my.c, "raw"))
my.c.encoding
